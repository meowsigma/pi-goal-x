...
Generated 2026-08-09T11:13:57.575Z · agent-free (B8) · local machine numbers (p50/p95/max, ms unless noted).
...
| B1.append.x4 | ledger append x4 (batched, one write) | goal-ledger | 1k-event ledger file | 1 | 20 | 0.1 | 0.4 | 0.4 | 0ms | mean 0.1ms; one appendFileSync for 4 events (was 4×5 ops) |
| B3.parse.1000 | ledger full parse (1000 events) | goal-ledger | 1000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.1000 | ledger reconstruction (1000 events) | goal-ledger | 1000 in-memory events | - | 30 | 0.1 | 0.1 | 0.3 | 0ms | mean 0.1ms |
| B3.parse.5000 | ledger full parse (5000 events) | goal-ledger | 5000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.5000 | ledger reconstruction (5000 events) | goal-ledger | 5000 in-memory events | - | 30 | 0.3 | 0.8 | 1.5 | 0ms | mean 0.4ms |
| B3.parse.10000 | ledger full parse (10000 events) | goal-ledger | 10000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.10000 | ledger reconstruction (10000 events) | goal-ledger | 10000 in-memory events | - | 30 | 0.5 | 0.9 | 1.5 | 0ms | mean 0.6ms |
...
| B5.startup.50g | session startup loadState (50 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 50 open goals | 0 | 6 | 0 | 3 | 3 | 0ms | mean 0.5ms; P1-7 parallel + cached |
...
| B5.auditor.dispatch | update_goal(complete) dispatch to pre-audit gate (auditor stubbed) | goal-core-tools + goal-completion + goal-state + goal-service + goal-ledger | 1 active goal each, 5 fixtures | - | 5 | 1.3 | 2.8 | 2.8 | 0ms | cold=1.2ms warm=2.8ms; P1-6 seeds the auditor session warm |
| B1.pool.cold | cold sync pool read (50 goals, fresh process) | storage/goal-files | 50 goals + settings + 1k-event ledger | 3 | 5 | 0.8 | 6 | 6 | 0ms | fresh-process cold read; wall samples 0.8/0.8/0.8/0.9/6ms; ops = min over samples (deterministic per code state) |
| B1.pool.cold.lat25 | cold sync pool read (50 goals, +25ms/op) | storage/goal-files | 50 goals + settings + 1k-event ledger | 3 | 5 | 94.7 | 105.6 | 105.6 | 25ms/op | fresh-process cold read; wall samples 87.7/91/94.7/105/105.6ms; ops = min over samples (deterministic per code state) |
...
| B1.settings.cold.lat25 | cold settings load (+25ms/op) | goal-settings | 50 goals + settings + 1k-event ledger | 1 | 5 | 35.3 | 35.4 | 35.4 | 25ms/op | fresh-process cold read; wall samples 29.3/32.2/35.3/35.4/35.4ms; ops = min over samples (deterministic per code state) |
| B1.ledger.cold | cold ledger read (1k events, fresh process) | goal-ledger | 50 goals + settings + 1k-event ledger | 1 | 5 | 1.3 | 1.3 | 1.3 | 0ms | fresh-process cold read; wall samples 1.2/1.2/1.3/1.3/1.3ms; ops = min over samples (deterministic per code state) |
| B1.ledger.cold.lat25 | cold ledger read (+25ms/op) | goal-ledger | 50 goals + settings + 1k-event ledger | 1 | 5 | 36.4 | 36.5 | 36.5 | 25ms/op | fresh-process cold read; wall samples 33.6/36.4/36.4/36.4/36.5ms; ops = min over samples (deterministic per code state) |
| B5.startup.cold | cold session startup loadState (50 goals, fresh process) | goal-state + storage/goal-files + goal-settings | 50 goals + settings + 1k-event ledger | 4 | 5 | 1.9 | 2.2 | 2.2 | 0ms | fresh-process cold read; wall samples 1.8/1.8/1.9/2/2.2ms; ops = min over samples (deterministic per code state) |
| B5.startup.cold.lat25 | cold session startup loadState (50 goals, +25ms/op) | goal-state + storage/goal-files + goal-settings | 50 goals + settings + 1k-event ledger | 4 | 5 | 115.6 | 119.1 | 119.1 | 25ms/op | fresh-process cold read; wall samples 111.5/112.7/115.6/116.9/119.1ms; ops = min over samples (deterministic per code state) |
| B1.ledgerstate.cold | cold checkpoint-aware read, no checkpoint (full parse + write) | goal-ledger | 50 goals + settings + 1k-event ledger | 2 | 5 | 1.6 | 4.1 | 4.1 | 0ms | fresh-process cold read; wall samples 1.5/1.5/1.6/1.6/4.1ms; ops = min over samples (deterministic per code state) |
| B1.ledgerstate.cp.hit | cold checkpoint-aware read, checkpoint covers the ledger | goal-ledger | 50 goals + settings + 1k-event ledger + checkpoint | 2 | 5 | 1.6 | 3.9 | 3.9 | 0ms | fresh-process cold read; wall samples 1.5/1.5/1.6/1.6/3.9ms; ops = min over samples (deterministic per code state) |
| B1.ledgerstate.cp.tail | cold checkpoint-aware read, 50-event external tail | goal-ledger | 50 goals + settings + 1k-event ledger + checkpoint | 2 | 5 | 1.5 | 1.6 | 1.6 | 0ms | fresh-process cold read; wall samples 1.5/1.5/1.5/1.6/1.6ms; ops = min over samples (deterministic per code state) |
| B7.tool.create_goal | create_goal handler | goal-core-tools + goal-state + goal-service + goal-notifications | 1 focused fixture | 14 | 5 | 0.7 | 1.4 | 1.4 | 0ms | fs ops/case ~14; mean 0.9ms |
...
| B7.tool.update_goal.paused | update_goal(paused) handler | goal-core-tools + goal-state + goal-service | 1 focused fixture | 19 | 5 | 0.9 | 1 | 1 | 0ms | fs ops/case ~19; mean 0.9ms |
| B7.tool.update_goal.blocked | update_goal(blocked) handler | goal-core-tools + goal-service + goal-ledger | 1 focused fixture | 19 | 5 | 0.9 | 1.2 | 1.2 | 0ms | fs ops/case ~19; mean 0.9ms |
| B7.tool.set_goal_tasks.50 | set_goal_tasks (50 tasks) handler | goal-task-tools + goal-task-confirmation + goal-policy + goal-service | 1 focused fixture | 19 | 5 | 1 | 1.2 | 1.2 | 0ms | fs ops/case ~19; mean 1ms |
...
| B7.evt.before_agent_start | before_agent_start event (1 goal, 1k ledger) | goal-events + goal-state + goal-service + goal-ledger + prompts/goal-prompts | 1 goal, 1000 events | - | 5 | 0 | 0 | 0 | 0ms | mean 0ms; P1-1/2 cut the reads here |
...
| B7.render.widgetLines | renderGoalWidgetLines (20 tasks) | widgets/goal-widget | 1 goal, 20 tasks | - | 100 | 0 | 0.1 | 0.5 | 0ms | mean 0ms |
...
| B7.pool.selectorLabel | goalSelectorLabel | goal-pool + goal-core | 1 goal | - | 2000 | 0 | 0 | 0.2 | 0ms | mean 0ms |
...
| B7.record.normalize | normalizeGoalRecord | goal-record | raw record | - | 2000 | 0 | 0 | 0.3 | 0ms | mean 0ms |
...
| B7.dashboard.model.20t | deriveGoalDashboardModel (20 tasks, 12 events) | widgets/goal-dashboard-model + goal-activity + goal-core | 1 goal, 20 tasks, 12 events | - | 100 | 0 | 0 | 0.2 | 0ms | mean 0ms |
...
| B7.dashboard.compact.20t | renderCompactDashboard (20 tasks) | widgets/goal-dashboard-renderer | 1 goal, 20 tasks | - | 100 | 0 | 0 | 0.1 | 0ms | mean 0ms |
...
| B7.dashboard.statusText | buildGoalStatusText standard (20 tasks) | goal-status + widgets/goal-dashboard-* | 1 goal, 20 tasks, 12 events | - | 100 | 0 | 0.1 | 0.4 | 0ms | mean 0.1ms |

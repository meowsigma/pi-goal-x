...
Generated 2026-08-06T12:37:14.104Z · agent-free (B8) · local machine numbers (p50/p95/max, ms unless noted).
...
|---|---|---|---|---|---|---|---|---|---|---|
| B1.settings.present | settings load (file present) | goal-settings | 1 settings file | 0 | 200 | 0 | 0 | 0.3 | 0ms | mean 0ms |
...
| B1.lock.uncontended | lock acquire+release (uncontended) | storage/goal-lock | fresh lock dir | 3 | 50 | 0.1 | 0.1 | 0.4 | 0ms | mean 0.1ms |
| B1.append.single | ledger append (single event) | goal-ledger | 1k-event ledger file | 1 | 50 | 0 | 0 | 0 | 0ms | mean 0ms |
| B1.append.x4 | ledger append x4 (batched, one write) | goal-ledger | 1k-event ledger file | 1 | 20 | 0 | 0 | 0 | 0ms | mean 0ms; one appendFileSync for 4 events (was 4×5 ops) |
| B3.parse.1000 | ledger full parse (1000 events) | goal-ledger | 1000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.1000 | ledger reconstruction (1000 events) | goal-ledger | 1000 in-memory events | - | 10 | 0 | 0.5 | 0.5 | 0ms | mean 0.1ms |
| B3.parse.5000 | ledger full parse (5000 events) | goal-ledger | 5000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.5000 | ledger reconstruction (5000 events) | goal-ledger | 5000 in-memory events | - | 10 | 0.3 | 0.8 | 0.8 | 0ms | mean 0.4ms |
| B3.parse.10000 | ledger full parse (10000 events) | goal-ledger | 10000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.10000 | ledger reconstruction (10000 events) | goal-ledger | 10000 in-memory events | - | 10 | 0.6 | 1 | 1 | 0ms | mean 0.6ms |
| B2.readturn.1g | per-turn read pipeline (1 goal, 1k ledger) | goal-settings + storage/goal-files + goal-ledger + prompts/goal-prompts | 1 goals, 1000 events | 0 | 20 | 0 | 1.4 | 1.4 | 0ms | fs ops/turn 0 (p50), mean 0.1ms |
| B2.readturn.10g | per-turn read pipeline (10 goals, 1k ledger) | goal-settings + storage/goal-files + goal-ledger + prompts/goal-prompts | 10 goals, 1000 events | 0 | 20 | 0 | 1.6 | 1.6 | 0ms | fs ops/turn 0 (p50), mean 0.1ms |
| B2.mutationturn.task | per-turn mutation (one update_goal_task) | goal-task-tools + goal-service + storage/goal-files + goal-ledger + storage/goal-lock | 1 goal, 1 task | 19 | 1 | 1.3 | 1.3 | 1.3 | 0ms | fs ops for one task mutation: 19 (P1-3 batches to one lock+write+append) |
...
| B5.startup.1g | session startup loadState (1 goal, parallel reads) | goal-state + storage/goal-files + goal-settings | 1 open goals | 0 | 6 | 0 | 0.7 | 0.7 | 0ms | mean 0.1ms; P1-7 parallel + cached |
...
| B5.startup.50g | session startup loadState (50 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 50 open goals | 0 | 6 | 0 | 2.7 | 2.7 | 0ms | mean 0.5ms; P1-7 parallel + cached |
...
| B5.lock.contended | lock acquire under two-process contention (child holds 3s, DEFAULT bounds) | storage/goal-lock | 2 processes, 1 goal lock | - | 1 | 12.8 | 12.8 | 12.8 | 0ms | fail-fast in 12.8ms; P1-5 bounded window ≈200ms (was ~2.8s frozen) |
| B5.auditor.dispatch | update_goal(complete) dispatch to pre-audit gate (auditor stubbed) | goal-core-tools + goal-completion + goal-state + goal-service + goal-ledger | 1 active goal each, 5 fixtures | - | 5 | 0.9 | 1.8 | 1.8 | 0ms | cold=0.9ms warm=1.8ms; P1-6 seeds the auditor session warm |
| B1.pool.cold | cold sync pool read (50 goals, fresh process) | storage/goal-files | 50 goals + settings + 1k-event ledger | 3 | 5 | 0.9 | 6.4 | 6.4 | 0ms | fresh-process cold read; wall samples 0.9/0.9/0.9/1/6.4ms; ops = min over samples (deterministic per code state) |
| B1.pool.cold.lat25 | cold sync pool read (50 goals, +25ms/op) | storage/goal-files | 50 goals + settings + 1k-event ledger | 3 | 5 | 98.6 | 100.9 | 100.9 | 25ms/op | fresh-process cold read; wall samples 94.1/97.3/98.6/98.8/100.9ms; ops = min over samples (deterministic per code state) |
...
| B1.settings.cold.lat25 | cold settings load (+25ms/op) | goal-settings | 50 goals + settings + 1k-event ledger | 1 | 5 | 35.5 | 35.6 | 35.6 | 25ms/op | fresh-process cold read; wall samples 30.4/35.5/35.5/35.5/35.6ms; ops = min over samples (deterministic per code state) |
| B1.ledger.cold | cold ledger read (1k events, fresh process) | goal-ledger | 50 goals + settings + 1k-event ledger | 1 | 5 | 1.4 | 1.4 | 1.4 | 0ms | fresh-process cold read; wall samples 1.3/1.3/1.4/1.4/1.4ms; ops = min over samples (deterministic per code state) |
| B1.ledger.cold.lat25 | cold ledger read (+25ms/op) | goal-ledger | 50 goals + settings + 1k-event ledger | 1 | 5 | 36.5 | 36.6 | 36.6 | 25ms/op | fresh-process cold read; wall samples 30.6/35.9/36.5/36.5/36.6ms; ops = min over samples (deterministic per code state) |
| B5.startup.cold | cold session startup loadState (50 goals, fresh process) | goal-state + storage/goal-files + goal-settings | 50 goals + settings + 1k-event ledger | 4 | 5 | 2 | 2.1 | 2.1 | 0ms | fresh-process cold read; wall samples 1.9/2/2/2.1/2.1ms; ops = min over samples (deterministic per code state) |
| B5.startup.cold.lat25 | cold session startup loadState (50 goals, +25ms/op) | goal-state + storage/goal-files + goal-settings | 50 goals + settings + 1k-event ledger | 4 | 5 | 112.3 | 117.6 | 117.6 | 25ms/op | fresh-process cold read; wall samples 108.7/110.1/112.3/113.3/117.6ms; ops = min over samples (deterministic per code state) |
| B7.tool.create_goal | create_goal handler | goal-core-tools + goal-state + goal-service + goal-notifications | 1 focused fixture | 11 | 5 | 0.6 | 1.3 | 1.3 | 0ms | fs ops/case ~11; mean 0.8ms |
...
| B7.tool.update_goal.paused | update_goal(paused) handler | goal-core-tools + goal-state + goal-service | 1 focused fixture | 16 | 5 | 0.8 | 0.9 | 0.9 | 0ms | fs ops/case ~16; mean 0.8ms |
| B7.tool.update_goal.blocked | update_goal(blocked) handler | goal-core-tools + goal-service + goal-ledger | 1 focused fixture | 16 | 5 | 0.7 | 0.9 | 0.9 | 0ms | fs ops/case ~16; mean 0.8ms |
| B7.tool.set_goal_tasks.50 | set_goal_tasks (50 tasks) handler | goal-task-tools + goal-task-confirmation + goal-policy + goal-service | 1 focused fixture | 16 | 5 | 0.9 | 3.5 | 3.5 | 0ms | fs ops/case ~16; mean 1.4ms |
| B7.tool.update_goal_task | update_goal_task(complete) handler | goal-task-tools + goal-service + storage/goal-lock + goal-ledger | 1 goal, 20 tasks | 19 | 5 | 0.8 | 0.9 | 0.9 | 0ms | fs ops/case ~19; mean 0.8ms |
...
| B7.render.widgetComponent | GoalWidgetComponent.render (mock TUI) | widgets/goal-widget | 1 goal, 20 tasks | - | 100 | 0 | 0 | 0.6 | 0ms | mean 0ms |
...
| B7.accounting.budget | budgetLine + budgetRemaining | goal-accounting | goal with 100k budget | - | 2000 | 0 | 0 | 0.5 | 0ms | mean 0ms |
...
| B7.files.serialize | serializeGoalFile | storage/goal-files + goal-core + goal-record | 1 goal | - | 1000 | 0 | 0 | 0.4 | 0ms | mean 0ms |
...
| B7.dashboard.model.50t | deriveGoalDashboardModel (50 tasks, 12 events) | widgets/goal-dashboard-model + goal-activity + goal-core | 1 goal, 50 tasks, 12 events | - | 100 | 0 | 0 | 0.2 | 0ms | mean 0ms |
...
| B7.dashboard.anchoredScroll.50t | flatten + anchoredScrollOffset (50 tasks) | widgets/goal-dashboard-model | 50-task tree | - | 500 | 0 | 0 | 0.2 | 0ms | mean 0ms |

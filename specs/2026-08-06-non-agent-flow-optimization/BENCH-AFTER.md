...
Generated 2026-08-09T10:36:52.994Z · agent-free (B8) · local machine numbers (p50/p95/max, ms unless noted).
...
| B1.append.single | ledger append (single event) | goal-ledger | 1k-event ledger file | 1 | 50 | 0 | 0 | 0.1 | 0ms | mean 0ms |
| B1.append.x4 | ledger append x4 (batched, one write) | goal-ledger | 1k-event ledger file | 1 | 20 | 0 | 0.1 | 0.1 | 0ms | mean 0ms; one appendFileSync for 4 events (was 4×5 ops) |
| B3.parse.1000 | ledger full parse (1000 events) | goal-ledger | 1000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.1000 | ledger reconstruction (1000 events) | goal-ledger | 1000 in-memory events | - | 10 | 0.1 | 0.1 | 0.1 | 0ms | mean 0.1ms |
| B3.parse.5000 | ledger full parse (5000 events) | goal-ledger | 5000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.5000 | ledger reconstruction (5000 events) | goal-ledger | 5000 in-memory events | - | 10 | 0.3 | 0.6 | 0.6 | 0ms | mean 0.3ms |
| B3.parse.10000 | ledger full parse (10000 events) | goal-ledger | 10000 events | - | 10 | 0 | 0 | 0 | 0ms | mean 0ms |
| B3.reconstruct.10000 | ledger reconstruction (10000 events) | goal-ledger | 10000 in-memory events | - | 10 | 0.4 | 2.1 | 2.1 | 0ms | mean 0.6ms |
...
| B2.mutationturn.task | per-turn mutation (one update_goal_task) | goal-task-tools + goal-service + storage/goal-files + goal-ledger + storage/goal-lock | 1 goal, 1 task | 19 | 1 | 1.2 | 1.2 | 1.2 | 0ms | fs ops for one task mutation: 19 (P1-3 batches to one lock+write+append) |
...
| B5.startup.10g | session startup loadState (10 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 10 open goals | 0 | 6 | 0 | 1.1 | 1.1 | 0ms | mean 0.2ms; P1-7 parallel + cached |
...
| B5.lock.contended | lock acquire under two-process contention (child holds 3s, DEFAULT bounds) | storage/goal-lock | 2 processes, 1 goal lock | - | 1 | 13.1 | 13.1 | 13.1 | 0ms | fail-fast in 13.1ms; P1-5 bounded window ≈200ms (was ~2.8s frozen) |
| B5.auditor.dispatch | update_goal(complete) dispatch to pre-audit gate (auditor stubbed) | goal-core-tools + goal-completion + goal-state + goal-service + goal-ledger | 1 active goal each, 5 fixtures | - | 5 | 1.4 | 2.9 | 2.9 | 0ms | cold=1.2ms warm=2.9ms; P1-6 seeds the auditor session warm |
| B1.pool.cold | cold sync pool read (50 goals, fresh process) | storage/goal-files | 50 goals + settings + 1k-event ledger | 3 | 5 | 0.8 | 10.1 | 10.1 | 0ms | fresh-process cold read; wall samples 0.8/0.8/0.8/0.9/10.1ms; ops = min over samples (deterministic per code state) |
| B1.pool.cold.lat25 | cold sync pool read (50 goals, +25ms/op) | storage/goal-files | 50 goals + settings + 1k-event ledger | 3 | 5 | 90.4 | 106.4 | 106.4 | 25ms/op | fresh-process cold read; wall samples 88.3/88.9/90.4/97.2/106.4ms; ops = min over samples (deterministic per code state) |
...
| B1.settings.cold.lat25 | cold settings load (+25ms/op) | goal-settings | 50 goals + settings + 1k-event ledger | 1 | 5 | 32.7 | 35.5 | 35.5 | 25ms/op | fresh-process cold read; wall samples 26.3/26.3/32.7/35.4/35.5ms; ops = min over samples (deterministic per code state) |
| B1.ledger.cold | cold ledger read (1k events, fresh process) | goal-ledger | 50 goals + settings + 1k-event ledger | 1 | 5 | 1.2 | 1.4 | 1.4 | 0ms | fresh-process cold read; wall samples 1.2/1.2/1.2/1.3/1.4ms; ops = min over samples (deterministic per code state) |
| B1.ledger.cold.lat25 | cold ledger read (+25ms/op) | goal-ledger | 50 goals + settings + 1k-event ledger | 1 | 5 | 36.4 | 36.5 | 36.5 | 25ms/op | fresh-process cold read; wall samples 35.2/36.4/36.4/36.4/36.5ms; ops = min over samples (deterministic per code state) |
| B5.startup.cold | cold session startup loadState (50 goals, fresh process) | goal-state + storage/goal-files + goal-settings | 50 goals + settings + 1k-event ledger | 4 | 5 | 1.9 | 1.9 | 1.9 | 0ms | fresh-process cold read; wall samples 1.8/1.8/1.9/1.9/1.9ms; ops = min over samples (deterministic per code state) |
| B5.startup.cold.lat25 | cold session startup loadState (50 goals, +25ms/op) | goal-state + storage/goal-files + goal-settings | 50 goals + settings + 1k-event ledger | 4 | 5 | 118.6 | 119.2 | 119.2 | 25ms/op | fresh-process cold read; wall samples 110.4/117.2/118.6/119/119.2ms; ops = min over samples (deterministic per code state) |
| B7.tool.create_goal | create_goal handler | goal-core-tools + goal-state + goal-service + goal-notifications | 1 focused fixture | 11 | 5 | 0.9 | 1.9 | 1.9 | 0ms | fs ops/case ~11; mean 1ms |
...
| B7.tool.update_goal.paused | update_goal(paused) handler | goal-core-tools + goal-state + goal-service | 1 focused fixture | 16 | 5 | 0.8 | 1 | 1 | 0ms | fs ops/case ~16; mean 0.9ms |
| B7.tool.update_goal.blocked | update_goal(blocked) handler | goal-core-tools + goal-service + goal-ledger | 1 focused fixture | 16 | 5 | 0.8 | 1 | 1 | 0ms | fs ops/case ~16; mean 0.8ms |
| B7.tool.set_goal_tasks.50 | set_goal_tasks (50 tasks) handler | goal-task-tools + goal-task-confirmation + goal-policy + goal-service | 1 focused fixture | 16 | 5 | 1 | 1.1 | 1.1 | 0ms | fs ops/case ~16; mean 1ms |
...
| B7.record.normalize | normalizeGoalRecord | goal-record | raw record | - | 2000 | 0 | 0 | 0.2 | 0ms | mean 0ms |
...
| B7.dashboard.expanded.50t | renderExpandedDashboard (50 tasks, 24 rows) | widgets/goal-dashboard-renderer | 1 goal, 50 tasks | - | 100 | 0 | 0.1 | 0.3 | 0ms | mean 0ms |
...
| B7.dashboard.statusText | buildGoalStatusText standard (20 tasks) | goal-status + widgets/goal-dashboard-* | 1 goal, 20 tasks, 12 events | - | 100 | 0 | 0.1 | 0.3 | 0ms | mean 0.1ms |

...
Generated 2026-08-06T12:14:39.614Z · agent-free (B8) · local machine numbers (p50/p95/max, ms unless noted).
...
| B1.append.single | ledger append (single event) | goal-ledger | 1k-event ledger file | 1 | 50 | 0 | 0.1 | 0.1 | 0ms | mean 0ms |
...
| B3.reconstruct.10000 | ledger reconstruction (10000 events) | goal-ledger | 10000 in-memory events | - | 10 | 0.5 | 0.5 | 0.5 | 0ms | mean 0.5ms |
...
| B2.readturn.10g | per-turn read pipeline (10 goals, 1k ledger) | goal-settings + storage/goal-files + goal-ledger + prompts/goal-prompts | 10 goals, 1000 events | 0 | 20 | 0 | 1.3 | 1.3 | 0ms | fs ops/turn 0 (p50), mean 0.1ms |
| B2.mutationturn.task | per-turn mutation (one update_goal_task) | goal-task-tools + goal-service + storage/goal-files + goal-ledger + storage/goal-lock | 1 goal, 1 task | 15 | 1 | 1.1 | 1.1 | 1.1 | 0ms | fs ops for one task mutation: 15 (P1-3 batches to one lock+write+append) |
...
| B5.startup.1g | session startup loadState (1 goal, parallel reads) | goal-state + storage/goal-files + goal-settings | 1 open goals | 0 | 6 | 0 | 0.4 | 0.4 | 0ms | mean 0.1ms; P1-7 parallel + cached |
...
| B5.startup.10g | session startup loadState (10 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 10 open goals | 0 | 6 | 0 | 0.7 | 0.7 | 0ms | mean 0.1ms; P1-7 parallel + cached |
...
| B5.startup.50g | session startup loadState (50 goals, parallel reads) | goal-state + storage/goal-files + goal-settings | 50 open goals | 0 | 6 | 0 | 2.5 | 2.5 | 0ms | mean 0.4ms; P1-7 parallel + cached |
...
| B5.lock.contended | lock acquire under two-process contention (child holds 3s, DEFAULT bounds) | storage/goal-lock | 2 processes, 1 goal lock | - | 1 | 13 | 13 | 13 | 0ms | fail-fast in 13ms; P1-5 bounded window ≈200ms (was ~2.8s frozen) |
| B5.auditor.dispatch | update_goal(complete) dispatch to pre-audit gate (auditor stubbed) | goal-core-tools + goal-completion + goal-state + goal-service + goal-ledger | 1 active goal each, 5 fixtures | - | 5 | 0.9 | 1.8 | 1.8 | 0ms | cold=0.8ms warm=1.8ms; P1-6 seeds the auditor session warm |
| B7.tool.create_goal | create_goal handler | goal-core-tools + goal-state + goal-service + goal-notifications | 1 focused fixture | 7 | 5 | 0.4 | 1 | 1 | 0ms | fs ops/case ~7; mean 0.5ms |
...
| B7.tool.update_goal.paused | update_goal(paused) handler | goal-core-tools + goal-state + goal-service | 1 focused fixture | 12 | 5 | 0.6 | 0.8 | 0.8 | 0ms | fs ops/case ~12; mean 0.6ms |
| B7.tool.update_goal.blocked | update_goal(blocked) handler | goal-core-tools + goal-service + goal-ledger | 1 focused fixture | 12 | 5 | 0.6 | 0.7 | 0.7 | 0ms | fs ops/case ~12; mean 0.6ms |
| B7.tool.set_goal_tasks.50 | set_goal_tasks (50 tasks) handler | goal-task-tools + goal-task-confirmation + goal-policy + goal-service | 1 focused fixture | 12 | 5 | 0.7 | 0.9 | 0.9 | 0ms | fs ops/case ~12; mean 0.7ms |
| B7.tool.update_goal_task | update_goal_task(complete) handler | goal-task-tools + goal-service + storage/goal-lock + goal-ledger | 1 goal, 20 tasks | 15 | 5 | 0.6 | 0.7 | 0.7 | 0ms | fs ops/case ~15; mean 0.6ms |
...
| B7.render.widgetLines | renderGoalWidgetLines (20 tasks) | widgets/goal-widget | 1 goal, 20 tasks | - | 100 | 0 | 0.1 | 0.6 | 0ms | mean 0ms |
...
| B7.accounting.budget | budgetLine + budgetRemaining | goal-accounting | goal with 100k budget | - | 2000 | 0 | 0 | 0.2 | 0ms | mean 0ms |
...
| B7.files.serialize | serializeGoalFile | storage/goal-files + goal-core + goal-record | 1 goal | - | 1000 | 0 | 0 | 0.3 | 0ms | mean 0ms |
...
| B7.dashboard.expanded.50t | renderExpandedDashboard (50 tasks, 24 rows) | widgets/goal-dashboard-renderer | 1 goal, 50 tasks | - | 100 | 0 | 0 | 0 | 0ms | mean 0ms |

# Benchmark diff — before → after (naf, 2026-08-06T12:19:04.856Z)
...
| B5.lock.contended | 245.6ms | 13ms | 0.05x | lock acquire under two-process contention (child holds 3s, DEFAULT bounds) |
| B3.reconstruct.10000 | 6.4ms | 0.5ms | 0.08x | ledger reconstruction (10000 events) |
| B3.reconstruct.5000 | 3.2ms | 0.3ms | 0.09x | ledger reconstruction (5000 events) |
| B3.reconstruct.1000 | 0.6ms | 0.1ms | 0.17x | ledger reconstruction (1000 events) |
...
| B7.tool.create_goal | 0.6ms | 0.4ms | 0.67x | create_goal handler |
| B7.tool.update_goal.paused | 0.7ms | 0.6ms | 0.86x | update_goal(paused) handler |
| B7.tool.update_goal_task | 0.7ms | 0.6ms | 0.86x | update_goal_task(complete) handler |
| B7.tool.set_goal_tasks.50 | 0.8ms | 0.7ms | 0.87x | set_goal_tasks (50 tasks) handler |
| B2.mutationturn.task | 1.2ms | 1.1ms | 0.92x | per-turn mutation (one update_goal_task) |
...
| B7.tool.update_goal.blocked | 0.6ms | 0.6ms | 1.00x | update_goal(blocked) handler |
